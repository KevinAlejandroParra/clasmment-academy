...
session_start();
    ...
    $usuarios_query = "SELECT * FROM usuarios WHERE usuario_estado = :estado AND usuario_documento = :usuario_documento";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['update'])) {
        ...
        $update_stmt->bindValue(':documento', $usuario, PDO::PARAM_INT);
        ...
        $delete_stmt->bindValue(':documento', $usuario);
...
<body class="bg-black min-h-screen relative overflow-hidden">
    ...
    <div class="container mx-auto p-4">
      <div class="navbar bg-transparent flex justify-between"> <!-- Navbar transparente -->
...
<div class="container mx-auto p-4">
    ...
    <?php endif; ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="stat bg-base-200 rounded-lg p-4 shadow-md" data-aos="fade-up" data-aos-delay="400">
                ...
                <div class="stat-title">Documento</div>
            ...
            <div class="stat bg-base-200 rounded-lg p-4 shadow-md" data-aos="fade-up" data-aos-delay="500">
                ...
                <div class="stat-value text-orange-400"> 
                    <!-- consulta para mostrar el nombre del rol correspondiente -->
                    <?php
                        $rol_id = $user['rol_id'];
                        $stmt = $conn->prepare("SELECT rol_nombre FROM roles WHERE rol_id = :rol_id");
    ...
    <div class="stat-value text-orange-400">
        ?php
            ...
            $stmt = $conn->prepare("SELECT escuela_nombre FROM escuelas WHERE escuela_id = :escuela_id");
            $stmt->bindValue(":escuela_id", $escuela_id);
            $stmt->execute();
            $escuela = $stmt->fetch(PDO::FETCH_ASSOC);
            echo htmlspecialchars($escuela['escuela_nombre']);
        ?>
    </div>
</div> -->
    ...
    <script>
        function closeAlert(alertId) {
            ...
            if (alert) {
                ...
                }, 300); // Ajusta este valor para que coincida con la duración de la transición CSS
            }
        }
