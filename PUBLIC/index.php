  ...
  <main class="pt-24">
      ...
      <div class="hero-content flex-col lg:flex-row-reverse pr-48">
        ...
        <div class="space-y-4">
          <div>
            ...
            <h1 class="text-6xl text-balance font-extrabold uppercase leading-[1.17] tracking-tight" data-aos="zoom-in">
              Nada es posible si no lo intentas
            </h1>
          </div>
          <p class="tracking-wide text-lg text-pretty" data-aos="zoom-in">
            Sácale el mayor provecho a tu tiempo y tus capacidades físicas, aprende y mejora
            tus habilidades blandas, elimina las excusas y las distracciones.
          </p>
          <div class="flex gap-5" data-aos="zoom-in">
            <a href="../APP/Views/Crud/login.php"
              class="btn rounded-full px-7 bg-orange-600 border-none shadow-lg shadow-orange-500/30 hover:bg-orange-600 hover:scale-105">
              ¡Empieza ahora!
            </a>
            <a href="../APP/Views/Crud/login_escuela.php"
              class="btn rounded-full px-7 bg-orange-600 border-none shadow-lg shadow-orange-500/30 hover:bg-orange-600 hover:scale-105">
              Soy escuela
            </a>
            <?php if (isset($_SESSION['usuario_documento']) && $_SESSION['usuario_documento'] == '1025531531'): ?>
              <a href="../APP/Views/ADMIN/escuelas.php"
                class="btn rounded-full px-7 bg-orange-600 border-none shadow-lg shadow-orange-500/30 hover:bg-orange-600 hover:scale-105">
                Gestionar escuela
              </a>
            <?php endif; ?>
    ...
    <div class="relative overflow-hidden py-16 bg-ghost" id="title-courses" data-aos="fade-up">
      <div class="container mx-auto px-4 space-y-5">
        <h2 class="text-4xl font-extrabold text-center capitalize">Cursos destacados</h2>
                    ...
                    <div class="flex space-x-8 items-center">
                      ...
                      <div class="card w-64 bg-base-100 shadow-xl opacity-50 transform scale-90 transition-all duration-300 rounded-lg">
                        ...
                        <div class="card-body p-4">
                          <h3 class="text-xl font-bold"><?= htmlspecialchars($courses[($index - 1 + count($courses)) % count($courses)]['curso_nombre']) ?></h3>
                        </div>
                      </div>
